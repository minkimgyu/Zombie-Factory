...
public class Bucky : Gun
{
    public override void ResetData(BuckyData data, RecoilRangeData mainRangeData, RecoilRangeData subRangeData, BaseFactory effectFactory)
    {
        ...
        _reloadState = new RoundByRoundReload(_weaponName, data.reloadBeforeDuration, data.reloadFinishDuration, data.reloadExitDuration, data.maxAmmoCountInMagazine, _animator, OnReloadRequested, OnPlayOwnerAnimation);
    }
}